...
class Board:
    ...
    def get_num_neighbouring_bombs(self,row,col):
        ...
        for r in range(row-1,row+2):
            for c in range(col-1,col+2):
                if r==row and c==col:
                    continue
                if r==self.dim_size or r<0 or c==self.dim_size or c<0:
                    continue
                if self.board[r][c]=='*':
    ...
    def __str__(self) -> str:
        # this a magic function where if call print on this object,
        # it'll print out what this function returns!
        # return a string that returns board to the player
...
def play(dim_size=10, num_bombs=10):
    # Step 1: create the board and plat the bombs
